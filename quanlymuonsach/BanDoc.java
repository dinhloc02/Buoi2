...
Scanner scanner = new Scanner(System.in);
  ...
  public void nhapThongTinType() {
    ...
    switch(loaiBanDoc) {
    case 1: this.setTypeBanDoc(TypeBanDoc.Sinh_Viên);   break;
    case 2: this.setTypeBanDoc(typeBanDoc.Học_viên_cao_học); break;
    case 3: this.setTypeBanDoc(typeBanDoc.Giáo_viên); break;
...
public String toString() {
	return "Loại bạn đọc:" + typeBanDoc +  ", mã bạn đọc" + getMaBanDoc()
			+ ", họ tên:" + getHoTen() + ", địa chỉ:" + getDiaChi() + ", số điện thoại :" + getSoDienThoai();
}	
}
