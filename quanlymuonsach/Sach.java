...
public class Sach  {
	...
	public void nhapThongTin() {
      ...
      boolean  check= true;
        ...
        switch(chuyenNganh) {
        case 1: this.setTypeSach(typeSach.Khoa_học_tự_nhiên);
        case 2: this.setTypeSach(typeSach.Văn_học_nghệ_thuật);
        case 3: this.setTypeSach(typeSach.Điện_tử_viễn_thông);
        case 4: this.setTypeSach(typeSach.Công_nghệ_thông_tin);
        }
